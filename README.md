...
When you play the Game of Zones, you win, or ... well you don't die but you might not win. We're going to be building some interactive games using our new knowledge of EVENTS, compounding our previous knowledge of functions, JavaScript fundamentals, and jQuery.
...
>HINT: You probably need to remove some event listeners ([vanilla](https://developer.mozilla.org/en-US/docs/Web/API/EventTarget/removeEventListener))([jquery](https://api.jquery.com/off))
...
1. Generate an array with the numbers `['zone-1', 'zone-2', 'zone-3', 'zone-4']` in a random order - you need some shuffling function, you can use sort method with Math.random to shuffle the array [shuffling using sort](https://www.freecodecamp.org/forum/t/how-does-math-random-work-to-sort-an-array/151540). This will determine the order in which you need to click the zones.
